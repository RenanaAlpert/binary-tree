    ...
    public:
        ...
        BinaryTree<T> &add_left(T father, T l)
        {
            ...
            for (; it != this->end(); ++it)
            {
                if (*it == father)
                {
                    if (it.get_current()->left == nullptr)
                    {
                        it.get_current()->left = new Node(l);
                    }
                    else
                    {
                        it.get_current()->left->value = l;
                    }
                    return *this;
                }
            }
        ...
        BinaryTree<T> &add_right(T father, T r)
        {
            ...
            for (; it != this->end(); ++it)
            {
                if (*it == father)
                {
                    if (it.get_current()->right == nullptr)
                    {
                        it.get_current()->right = new Node(r);
                    }
                    else
                    {
                        it.get_current()->right->value = r;
                    }
                    return *this;
                }
            }
